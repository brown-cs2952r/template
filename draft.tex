...
% Note: The 'acmart' class automatically loads several essential packages,
% including booktabs, amsmath, graphicx, and hyperref.

\usepackage{enumitem}     % For list customization
\usepackage{soul}         % Used for highlighting (\hl) in the \TODO command
\usepackage{xspace}       % For smart spacing in custom commands like \sys
\usepackage{xcolor}       % Required by soul and minted for colors
\usepackage{upquote}      % For correct single quotes in minted environments
\usepackage{minted}       % For syntax highlighting of code snippets
\usepackage{caption}      % For customizing captions with \captionsetup
